...
| Desktop asset name/integrity verify | `verify_desktop_assets.py` + `generate_sha256sums.py` | **partial** | M21 CI emits desktop `SHA256SUMS`/`asset-manifest.json` + warn-mode verify; **not** strict fail gate or launch proof |
