...
- [x] **Step 1: Add failing client tests for structured locations**
...
- [x] **Step 3: Implement the minimal structured error parser**
...
- [x] **Step 4: Add failing native bridge privacy test**
...
- [x] **Step 5: Run the bridge test and verify RED**
...
- [x] **Step 6: Redact raw query invocation failures**
...
- [x] **Step 7: Run focused client/bridge tests**
...
- [x] **Step 1: Add failing panel tests for bounded history**
...
- [x] **Step 2: Add failing panel tests for examples and syntax**
...
- [x] **Step 3: Run the panel test and verify RED**
...
- [x] **Step 4: Implement the workbench side rail**
...
- [x] **Step 5: Run the panel test and verify GREEN**
...
- [x] **Step 1: Add failing object-navigation test**
...
- [x] **Step 2: Add failing stale-response tests**
...
- [x] **Step 4: Implement navigation and response guards**
...
- [x] **Step 5: Render structured error coordinates**
...
- [x] **Step 6: Run all focused M28.A tests**
...
- [x] **Step 1: Run the related route adapter test**
...
- [x] **Step 2: Run TypeScript lint and production build**
...
- [x] **Step 1: Add failing client tests for one accumulated request**
...
- [x] **Step 2: Add failing stale/unavailable/provenance tests**
...
- [x] **Step 4: Implement the minimal enrichment client**
...
- [x] **Step 5: Run the client test and verify GREEN**
...
- [x] **Step 1: Add failing focused panel tests**
...
- [x] **Step 2: Add failing one-submit and outcome-label tests**
...
- [x] **Step 4: Implement and mount the focused panel**
...
- [x] **Step 5: Prove lean open remains unchanged**
...
- [x] **Step 6: Run focused explorer tests**
...
- [x] **Step 1: Add failing analyzer-rail assertions**
...
- [x] **Step 2: Run the explorer test and verify RED**
...
- [x] **Step 3: Render bounded recommendation content and provenance**
...
- [x] **Step 4: Run the explorer test and verify GREEN**
...
- [x] **Step 3: Add the baseline-source helper and picker**
...
- [x] **Step 1: Add failing disclosure assertions**
...
- [x] **Step 3: Add disclosure without widening compare behavior**
...
- [x] **Step 4: Run the picker test and verify GREEN**
...
- [x] **Step 1: Run all focused M28.B tests**
...
- Native report results use `{ format, content, mimeType, byteLength, mode, provenance }`; flamegraph results preserve the existing JSON object payload where applicable. `prepareExportDownload(...)` normalizes every payload to a string before Blob creation.
...
- [x] **Step 1: Add failing filename and content tests**

  In `export-download.test.ts`, assert that a display name such as `../../<img src=x onerror=alert(1)>.hprof` produces a basename-only, extension-allowlisted filename with no `/`, `\`, `<`, `>`, or quotes. Hostile markup words may survive only as inert normalized filename tokens. Cover empty/all-invalid names and a name longer than the exported filename limit.
...
- [x] **Step 3: Implement the minimal download contract**
...
- [x] **Step 4: Add and test the click-download helper**
...
- [x] **Step 5: Run the utility test and verify GREEN**
...
- [x] **Step 3: Add the native response cache and export command**
...
- [x] **Step 4: Preserve mode/provenance and HTML escaping**
...
- [x] **Step 5: Wire the typed desktop bridge**
...
- [x] **Step 6: Run focused bridge tests**
...
- [x] **Step 1: Add failing flamegraph format tests**
...
- [x] **Step 2: Add failing report export tests**
...
- [x] **Step 3: Run the focused page test and verify RED**
...
- [x] **Step 4: Implement flamegraph format selection**
...
- [x] **Step 5: Implement report export controls**
...
- [x] **Step 6: Run focused export tests and verify GREEN**
...
- [x] **Step 1: Run TypeScript lint and production build**

  Run: `cd ui && bun run lint && bun run build`

  Expected: both commands exit 0.

- [x] **Step 2: Run focused native checks where this host permits**
...
- [x] **Step 2: Synchronize status, matrix, and roadmap**
...
- [x] **Step 3: Check all M28 plan boxes**
...
- [x] **Step 4: Verify documentation and scope**
