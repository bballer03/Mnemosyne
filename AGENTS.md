...
This project is indexed by GitNexus as **step11-scaling** (1745 symbols, 4612 relationships, 151 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/step11-scaling/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/step11-scaling/context` | Codebase overview, check index freshness |
| `gitnexus://repo/step11-scaling/clusters` | All functional areas |
| `gitnexus://repo/step11-scaling/processes` | All execution flows |
| `gitnexus://repo/step11-scaling/process/{name}` | Step-by-step execution trace |
