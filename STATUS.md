...
## Snapshot
- ✅ **v0.1.1 is the current release** and includes a documentation-aligned core crate restructure from flat files into grouped module directories under `core/src/` (`hprof/`, `graph/`, `analysis/`, `mapper/`, `report/`, `fix/`, `mcp/`).
