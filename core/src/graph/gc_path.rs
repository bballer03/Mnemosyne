use crate::{
    ...
    hprof::{
        ...
        ParseOptions, SUB_CLASS_DUMP as CLASS_DUMP_SUBTAG,
        SUB_HEAP_DUMP_INFO as ROOT_HEAP_DUMP_INFO, SUB_INSTANCE_DUMP as INSTANCE_DUMP_SUBTAG,
        SUB_OBJ_ARRAY_DUMP as OBJECT_ARRAY_DUMP_SUBTAG,
